...
- Fixed issue with `Patients.QueryAsync` method not properly handling paginated requests.
...
- Added `Patient.Registration.SroItem.DeleteAsync` and `Patient.Registration.SroSummary.DeleteAsync` methods.
